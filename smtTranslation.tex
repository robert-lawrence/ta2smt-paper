...
\begin{table}
  \centering
\begin{tabular}{c c}
\multicolumn{2}{c}{Sync Constraints} \\
\midrule
...
\centering
\begin{tabular}{c c}
\multicolumn{2}{c}{Loop Constraints} \\
\midrule
...
bounds, if even larger models and higher bounds were to be added to the results,
we expect that the results would be even more favorable to ta2smt. An
interesting exception to this trend seems to be the bound of thirty, where
ta2smt exhibits a lower speedup than with a bound of twenty-five. After
consulting the tables we highly suspect that this is due to a quirk of the \aez\
encoding, where the results with a bound of thirty are slightly better than with
a bound of twenty-five for several problems. We are not sure as to the cause of
this strange phenomenon, but we do not expect this to repeat at higher bounds.
